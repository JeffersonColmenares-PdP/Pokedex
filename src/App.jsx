...
function App() {
  ...
  const indexOfLastPokemon = currentPage * pokemonsPerPage; // último pokemon en página
  const indexOfFirstPokemon = indexOfLastPokemon - pokemonsPerPage; // primer pokemon en página
